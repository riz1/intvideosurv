...
namespace IntVideoSurv.DataAccess
{
    public class GroupSwitchGroupDataAccess
    {
        ...
        {
            string cmdText = "select max(Id) from IVS_GroupSwitchGroup";
            try
            {
        ...
        public static int Insert(Database db, GroupSwitchGroup oGroupInfo)
        {
            ...
            sbField.Append("INSERT INTO IVS_GroupSwitchGroup(");
        ...
        public static int Update(Database db, GroupSwitchGroup oGroupInfo)
        {
            ...
            sb.Append("update IVS_GroupSwitchGroup set");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("delete from IVS_GroupSwitchGroup ");
        ...
        {
            string cmdText = string.Format("select * from IVS_GroupSwitchGroup order by Id");
            try
            {
        ...
        {
            string cmdText = string.Format("select * from IVS_GroupSwitchGroup where Id={0} ", groupId);
            try
            {
                return db.ExecuteDataSet(CommandType.Text, cmdText);
