...
namespace CameraViewer
{
    public partial class MainForm : XtraForm
    {
        ...
        public MainForm()
        {
            ...
            //注册热键
            RegisterHotKey(this.Handle, 201, (int)MyKeys.Ctrl, (int)Keys.D1); //注册热键Alt+1       
            RegisterHotKey(this.Handle, 202, (int)MyKeys.Ctrl, (int)Keys.D2); //注册热键Alt+1            
            RegisterHotKey(this.Handle, 203, (int)MyKeys.Ctrl, (int)Keys.D3); //注册热键Alt+1
            RegisterHotKey(this.Handle, 204, (int)MyKeys.Ctrl, (int)Keys.D4); //注册热键Alt+1
            RegisterHotKey(this.Handle, 205, (int)MyKeys.Ctrl, (int)Keys.D5); //注册热键Alt+1
            RegisterHotKey(this.Handle, 206, (int)MyKeys.Ctrl, (int)Keys.D6); //注册热键Alt+1
            RegisterHotKey(this.Handle, 207, (int)MyKeys.Ctrl, (int)Keys.D7); //注册热键Alt+1
            RegisterHotKey(this.Handle, 208, (int)MyKeys.Ctrl, (int)Keys.D8); //注册热键Alt+1
            RegisterHotKey(this.Handle, 209, (int)MyKeys.Ctrl, (int)Keys.D9); //注册热键Alt+1
